...
@Component({
  selector: 'app-tickets-inactive',
  templateUrl: './tickets-inactive.component.html',
  styleUrls: ['./tickets-inactive.component.css']
})
export class TicketsInactiveComponent implements OnInit {
...
export class ExampleHttpDao {
  ...
  getTickets() {
    return this.ticketsService.getInactiveTickets()
  }
}
